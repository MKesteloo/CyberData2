library(corrplot)
data <- read.csv(file="C:/Users/mitch/Documents/MSc/Cyber Data Analytics/datasetslab2/set1.csv", header=TRUE, sep=",")
...
par(resetPar())
plot(data$L_T1[1:400], type = 'l', col = 'red', ylim=range(0,6))
...
par(mfrow=c(2,1))
plot(data$F_PU2[1:400], type = 'l', col = 'red')
plot(data$S_PU2[1:400], type = 'l', col = 'blue')
